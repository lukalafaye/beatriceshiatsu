...
Site vitrine de **Shiatsu Être et Sens** — Béatrice Morel, praticienne shiatsu et énergéticienne à Vonnas (01540).
...
- [ ] **Mentions légales** : compléter statut juridique, SIRET, e-mail, responsable de la publication.
- [ ] **Événements** : la section contient un atelier d'exemple sans date. Mettre à jour ou retirer.
- [ ] **E-mail** : aucun n'était fourni ; le site ne propose que le téléphone.
...
- **Données structurées** `HealthAndBeautyBusiness` (JSON-LD) pour le référencement local autour de Vonnas.
